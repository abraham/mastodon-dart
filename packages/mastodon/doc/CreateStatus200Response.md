# mastodon.model.CreateStatus200Response
...
**card** | [**PreviewCard**](PreviewCard.md) | Preview card for links included within status content. | [optional] 
...
**poll** | [**Poll**](Poll.md) | The poll attached to the status. | [optional] 
**quote** | [**StatusQuote**](StatusQuote.md) |  | [optional] 
**quoteApproval** | [**QuoteApproval**](QuoteApproval.md) | Summary of the post quote's approval policy and how it applies to the user making the request, that is, whether the user can be expected to be allowed to quote that post | [optional] 
