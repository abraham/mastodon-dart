...
**category** | [**ReportCategoryEnum**](ReportCategoryEnum.md) | Specify if the report is due to `spam`, `legal` (illegal content), `violation` of enumerated instance rules, or some `other` reason. Defaults to `other`. Will be set to `violation` if `rule_ids[]` is provided (regardless of any category value you provide). | [optional] [default to ReportCategoryEnum.other]
**collectionIds** | **List&lt;String&gt;** | You can attach Collections to the report to provide additional context. | [optional] 
