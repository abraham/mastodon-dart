...
Preferences defined by the user in their account settings.  Version history:  2.8.0 - added\\ 4.1.0 - added `reading:autoplay:gifs`\\ 4.5.0 (`mastodon` [API version] 7) - added `posting:default:quoted_policy`
