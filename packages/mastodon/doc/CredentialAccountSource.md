...
**quotePolicy** | [**ScheduledStatusParamsQuoteApprovalPolicyEnum**](ScheduledStatusParamsQuoteApprovalPolicyEnum.md) | The default quote policy to be used for new statuses. | [optional] 
