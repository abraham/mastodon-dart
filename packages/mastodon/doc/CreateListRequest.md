...
**repliesPolicy** | [**ListRepliesPolicyEnum**](ListRepliesPolicyEnum.md) | One of `followed`, `list`, or `none`. Defaults to `list`. | [optional] [default to ListRepliesPolicyEnum.list]
