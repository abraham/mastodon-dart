# mastodon.model.InstanceThumbnail
...
**description** | **String** | The thumbnail's alt text (a description of the image to help people with visual impairments understand its content). | [optional] 
