...
Report problematic accounts and contents to your moderators.  Version history:  1.1 - added\\ 2.3.0 - add `forward` parameter\\ 3.5.0 - add `category` and `rule_ids` parameters\\ 4.0.0 - `category` is now optional if `rule_ids` is provided\\ 4.2.0 - add `legal` category\\ 4.6.0 - add `collection_ids` parameter
