...
class CreateFilterRequest {
  /// Returns a new [CreateFilterRequest] instance.
  CreateFilterRequest({
  ...
  factory CreateFilterRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateFilterRequestFromJson(json);
