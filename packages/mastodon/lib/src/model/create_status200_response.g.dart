...
abstract class _$CreateStatus200ResponseCWProxy {
  CreateStatus200Response account(Account account);

  CreateStatus200Response content(String content);

  CreateStatus200Response createdAt(DateTime createdAt);

  CreateStatus200Response emojis(List<CustomEmoji> emojis);

  CreateStatus200Response favouritesCount(int favouritesCount);

  CreateStatus200Response id(String id);

  CreateStatus200Response mediaAttachments(
    List<MediaAttachment> mediaAttachments,
  );

  CreateStatus200Response mentions(List<StatusMention> mentions);

  CreateStatus200Response reblogsCount(int reblogsCount);

  CreateStatus200Response repliesCount(int repliesCount);

  CreateStatus200Response sensitive(bool sensitive);

  CreateStatus200Response spoilerText(String spoilerText);

  CreateStatus200Response tags(List<StatusTag> tags);

  CreateStatus200Response uri(String uri);

  CreateStatus200Response visibility(StatusVisibilityEnum visibility);

  CreateStatus200Response params(ScheduledStatusParams params);

  CreateStatus200Response scheduledAt(DateTime scheduledAt);

  CreateStatus200Response application(StatusApplication? application);

  CreateStatus200Response bookmarked(bool? bookmarked);

  CreateStatus200Response card(PreviewCard? card);

  CreateStatus200Response editedAt(DateTime? editedAt);

  CreateStatus200Response favourited(bool? favourited);

  CreateStatus200Response filtered(List<FilterResult>? filtered);

  CreateStatus200Response inReplyToAccountId(String? inReplyToAccountId);

  CreateStatus200Response inReplyToId(String? inReplyToId);

  CreateStatus200Response language(String? language);

  CreateStatus200Response muted(bool? muted);

  CreateStatus200Response pinned(bool? pinned);

  CreateStatus200Response poll(Poll? poll);

  CreateStatus200Response quote(StatusQuote? quote);

  CreateStatus200Response quoteApproval(QuoteApproval? quoteApproval);

  CreateStatus200Response quotesCount(int? quotesCount);

  CreateStatus200Response reblog(Status? reblog);

  CreateStatus200Response reblogged(bool? reblogged);

  CreateStatus200Response taggedCollections(
    List<Collection>? taggedCollections,
  );

  CreateStatus200Response text(String? text);

  CreateStatus200Response url(Uri? url);
...
/// Use as `instanceOfCreateStatus200Response.copyWith(...)` or call `instanceOfCreateStatus200Response.copyWith.fieldName(value)` for a single field.
class _$CreateStatus200ResponseCWProxyImpl
    implements _$CreateStatus200ResponseCWProxy {
  const _$CreateStatus200ResponseCWProxyImpl(this._value);

  final CreateStatus200Response _value;

  @override
  CreateStatus200Response account(Account account) => call(account: account);

  @override
  CreateStatus200Response content(String content) => call(content: content);
  ...
  @override
  CreateStatus200Response favouritesCount(int favouritesCount) =>
      call(favouritesCount: favouritesCount);

  @override
  CreateStatus200Response id(String id) => call(id: id);
  ...
  @override
  CreateStatus200Response reblogsCount(int reblogsCount) =>
      call(reblogsCount: reblogsCount);

  @override
  CreateStatus200Response repliesCount(int repliesCount) =>
      call(repliesCount: repliesCount);
  ...
  @override
  CreateStatus200Response tags(List<StatusTag> tags) => call(tags: tags);

  @override
  CreateStatus200Response uri(String uri) => call(uri: uri);
  ...
  @override
  CreateStatus200Response card(PreviewCard? card) => call(card: card);

  @override
  CreateStatus200Response editedAt(DateTime? editedAt) =>
      call(editedAt: editedAt);

  @override
  CreateStatus200Response favourited(bool? favourited) =>
      call(favourited: favourited);

  @override
  CreateStatus200Response filtered(List<FilterResult>? filtered) =>
      call(filtered: filtered);

  @override
  CreateStatus200Response inReplyToAccountId(String? inReplyToAccountId) =>
      call(inReplyToAccountId: inReplyToAccountId);
  ...
  @override
  CreateStatus200Response muted(bool? muted) => call(muted: muted);

  @override
  CreateStatus200Response pinned(bool? pinned) => call(pinned: pinned);

  @override
  CreateStatus200Response poll(Poll? poll) => call(poll: poll);

  @override
  CreateStatus200Response quote(StatusQuote? quote) => call(quote: quote);

  @override
  CreateStatus200Response quoteApproval(QuoteApproval? quoteApproval) =>
      call(quoteApproval: quoteApproval);

  @override
  CreateStatus200Response quotesCount(int? quotesCount) =>
      call(quotesCount: quotesCount);

  @override
  CreateStatus200Response reblog(Status? reblog) => call(reblog: reblog);

  @override
  CreateStatus200Response reblogged(bool? reblogged) =>
      call(reblogged: reblogged);
  ...
  @override
  CreateStatus200Response text(String? text) => call(text: text);
  ...
  CreateStatus200Response call({
    ...
    Object? quoteApproval = const $CopyWithPlaceholder(),
    ...
    return CreateStatus200Response(
      ...
      favouritesCount:
          favouritesCount == const $CopyWithPlaceholder() ||
      ...
      mentions: mentions == const $CopyWithPlaceholder() || mentions == null
          ? _value.mentions
          // ignore: cast_nullable_to_non_nullable
          : mentions as List<StatusMention>,
      reblogsCount:
      ...
      application: application == const $CopyWithPlaceholder()
          ? _value.application
          // ignore: cast_nullable_to_non_nullable
          : application as StatusApplication?,
      ...
      quoteApproval: quoteApproval == const $CopyWithPlaceholder()
          ? _value.quoteApproval
          // ignore: cast_nullable_to_non_nullable
          : quoteApproval as QuoteApproval?,
      quotesCount: quotesCount == const $CopyWithPlaceholder()
          ? _value.quotesCount
          // ignore: cast_nullable_to_non_nullable
          : quotesCount as int?,
...
extension $CreateStatus200ResponseCopyWith on CreateStatus200Response {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfCreateStatus200Response.copyWith(...)` or `instanceOfCreateStatus200Response.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$CreateStatus200ResponseCWProxy get copyWith =>
      _$CreateStatus200ResponseCWProxyImpl(this);
}
