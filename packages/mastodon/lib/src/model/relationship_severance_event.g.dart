  ...
  RelationshipSeveranceEvent call({
    ...
    return RelationshipSeveranceEvent(
      ...
      id: id == const $CopyWithPlaceholder() || id == null
          ...
          // ignore: cast_nullable_to_non_nullable
          : id as String,
      purged: purged == const $CopyWithPlaceholder() || purged == null
          ? _value.purged
          // ignore: cast_nullable_to_non_nullable
          : purged as bool,
      targetName:
          targetName == const $CopyWithPlaceholder() || targetName == null
          ? _value.targetName
          // ignore: cast_nullable_to_non_nullable
...
RelationshipSeveranceEvent _$RelationshipSeveranceEventFromJson(
  ...
  ($checkedConvert) {
    ...
    final val = RelationshipSeveranceEvent(
      ...
      type: $checkedConvert(
        'type',
        (v) => $enumDecode(_$RelationshipSeveranceEventTypeEnumEnumMap, v),
      ),
    );
    return val;
  },
