...
class MutedAccountMoved {
  /// Returns a new [MutedAccountMoved] instance.
  MutedAccountMoved({
    required this.acct,
  ...
  factory MutedAccountMoved.fromJson(Map<String, dynamic> json) =>
      _$MutedAccountMovedFromJson(json);

  Map<String, dynamic> toJson() => _$MutedAccountMovedToJson(this);
