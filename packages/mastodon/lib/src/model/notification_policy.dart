...
class NotificationPolicy {
  ...
  @JsonKey(name: r'for_limited_accounts', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'for_new_accounts', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'for_not_followers', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'for_not_following', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'for_private_mentions', required: true, includeIfNull: false)
