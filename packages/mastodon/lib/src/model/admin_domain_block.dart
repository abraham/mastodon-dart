...
import 'package:mastodon/src/model/admin_domain_block_severity_enum.dart';
...
class AdminDomainBlock {
  ...
  @JsonKey(name: r'obfuscate', required: true, includeIfNull: false)
  final bool obfuscate;

  /// Whether to reject media attachments from this domain
  @JsonKey(name: r'reject_media', required: true, includeIfNull: false)
  final bool rejectMedia;

  /// Whether to reject reports from this domain
  @JsonKey(name: r'reject_reports', required: true, includeIfNull: false)
