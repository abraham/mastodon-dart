    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = V1NotificationPolicy(
          filterNewAccounts:
              $checkedConvert('filter_new_accounts', (v) => v as bool),
          filterNotFollowers:
              $checkedConvert('filter_not_followers', (v) => v as bool),
          filterNotFollowing:
              $checkedConvert('filter_not_following', (v) => v as bool),
          filterPrivateMentions:
              $checkedConvert('filter_private_mentions', (v) => v as bool),
