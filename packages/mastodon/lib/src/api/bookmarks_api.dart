...
class BookmarksApi {
  ...
  /// Also see [View bookmarked statuses Documentation](https://docs.joinmastodon.org/methods/bookmarks/#get)
  Future<Response<List<Status>>> getBookmarks({
    int? limit = 20,
    String? maxId,
    String? minId,
    String? sinceId,
    ...
    final _path = r'/api/v1/bookmarks';
