...
class DomainBlocksApi {
  ...
  /// Also see [Block a domain Documentation](https://docs.joinmastodon.org/methods/domain_blocks/#block)
  Future<Response<void>> createDomainBlock({
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Get domain blocks Documentation](https://docs.joinmastodon.org/methods/domain_blocks/#get)
  Future<Response<List<String>>> getDomainBlocks({
    int? limit = 100,
    String? maxId,
    String? minId,
    String? sinceId,
