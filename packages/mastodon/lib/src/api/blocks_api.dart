...
class BlocksApi {
  ...
  /// Also see [View blocked users Documentation](https://docs.joinmastodon.org/methods/blocks/#get)
  Future<Response<List<Account>>> getBlocks({
    int? limit = 40,
    String? maxId,
    String? minId,
    String? sinceId,
