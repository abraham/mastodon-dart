...
class ProfileApi {
  ...
  Future<Response<CredentialAccount>> deleteAvatar({
    ...
    final _path = r'/api/v1/profile/avatar';
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Delete profile header Documentation](https://docs.joinmastodon.org/methods/profile/#delete-profile-header)
  Future<Response<CredentialAccount>> deleteProfileHeader({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/profile/header';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Get current user profile Documentation](https://docs.joinmastodon.org/methods/profile/#get-current-user-profile)
  ...
  ///
  /// Parameters:
  /// * [patchProfileRequest] - JSON request body parameters
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Update current user profile Documentation](https://docs.joinmastodon.org/methods/profile/#update-current-user-profile)
  Future<Response<Profile>> patchProfile({
    ...
    try {
      _bodyData = jsonEncode(patchProfileRequest);
    } catch (error, stackTrace) {
      throw DioException(
