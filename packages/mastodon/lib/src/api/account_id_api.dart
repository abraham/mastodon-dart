...
class AccountIdApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Get all Collections an account is featured in Documentation](https://docs.joinmastodon.org/methods/collections/#in_collections)
  Future<Response<void>> getByAccountIdInCollections({
    required String accountId,
    int? limit = 40,
    int? offset = 0,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/{account_id}/in_collections'.replaceAll(
      '{'
      r'account_id'
      '}',
      accountId.toString(),
