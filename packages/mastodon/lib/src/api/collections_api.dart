...
class CollectionsApi {
  ...
  ///
  /// Parameters:
  /// * [createCollectionRequest] - JSON request body parameters
  ...
  Future<Response<void>> createCollection({
    ...
    final _path = r'/api/v1/collections';
    ...
    try {
      _bodyData = jsonEncode(createCollectionRequest);
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Delete a Collection Documentation](https://docs.joinmastodon.org/methods/collections/#delete_collection)
  Future<Response<void>> deleteCollection({
    ...
    final _path = r'/api/v1/collections/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Remove account from a Collection Documentation](https://docs.joinmastodon.org/methods/collections/#remove_account)
  Future<Response<void>> deleteCollectionItem({
    ...
    final _path = r'/api/v1/collections/{collection_id}/items/{id}'
        .replaceAll(
          '{'
          r'collection_id'
          '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionWithAccounts] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Get a single Collection Documentation](https://docs.joinmastodon.org/methods/collections/#get_collection)
  Future<Response<CollectionWithAccounts>> getCollection({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    CollectionWithAccounts? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<CollectionWithAccounts, CollectionWithAccounts>(
              rawData,
    ...
    return Response<CollectionWithAccounts>(
      data: _responseData,
  ...
  /// Parameters:
  /// * [collectionId] - collection_id parameter
  /// * [postCollectionItemsRequest] - JSON request body parameters
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> postCollectionItems({
    ...
    final _path = r'/api/v1/collections/{collection_id}/items'.replaceAll(
      '{'
      r'collection_id'
      '}',
      collectionId.toString(),
    ...
    try {
      _bodyData = jsonEncode(postCollectionItemsRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Parameters:
  /// * [id] - id parameter
  /// * [updateCollectionRequest] - JSON request body parameters
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> updateCollection({
    ...
    try {
      _bodyData = jsonEncode(updateCollectionRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
