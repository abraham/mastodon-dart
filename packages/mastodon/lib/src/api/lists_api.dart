...
class ListsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [List] as data
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Create a list Documentation](https://docs.joinmastodon.org/methods/lists/#create)
  Future<Response<ModelList>> createList({
    required CreateListRequest createListRequest,
    ...
    try {
      _bodyData = jsonEncode(createListRequest);
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<ModelList, ModelList>(rawData, 'ModelList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Delete a list Documentation](https://docs.joinmastodon.org/methods/lists/#delete)
  Future<Response<void>> deleteList({
    ...
    final _path =
        r'/api/v1/lists/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteListAccounts({
    ...
    final _path =
        r'/api/v1/lists/{id}/accounts'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Show a single list Documentation](https://docs.joinmastodon.org/methods/lists/#get-one)
  ...
  /// Parameters:
  /// * [id] - id parameter
  /// * [limit] - Maximum number of results. Defaults to 40 accounts. Max 80 accounts. Set to 0 in order to get all accounts without pagination.
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View accounts in a list Documentation](https://docs.joinmastodon.org/methods/lists/#accounts)
  Future<Response<List<Account>>> getListAccounts({
    required String id,
    int? limit = 40,
    String? maxId,
    String? minId,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [View your lists Documentation](https://docs.joinmastodon.org/methods/lists/#get)
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Add accounts to a list Documentation](https://docs.joinmastodon.org/methods/lists/#accounts-add)
  Future<Response<void>> postListAccounts({
    required String id,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Update a list Documentation](https://docs.joinmastodon.org/methods/lists/#update)
