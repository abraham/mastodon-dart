...
class TagsApi {
  ...
  Future<Response<Tag>> getTagsByName({
    ...
    final _path =
        r'/api/v1/tags/{name}'.replaceAll('{' r'name' '}', name.toString());
  ...
  Future<Response<Tag>> postTagFeature({
    ...
    final _path =
        r'/api/v1/tags/{id}/feature'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Tag>> postTagFollow({
    ...
    final _path = r'/api/v1/tags/{name}/follow'
  ...
  Future<Response<Tag>> postTagUnfeature({
    ...
    final _path =
        r'/api/v1/tags/{id}/unfeature'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Tag>> postTagUnfollow({
    ...
    final _path = r'/api/v1/tags/{name}/unfollow'
        .replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
