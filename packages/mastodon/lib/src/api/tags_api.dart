...
class TagsApi {
  ...
  Future<Response<Tag>> getTagsByName({
    ...
    final _path = r'/api/v1/tags/{name}'.replaceAll(
      '{'
      r'name'
      '}',
      name.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Feature a hashtag Documentation](https://docs.joinmastodon.org/methods/tags/#feature)
  Future<Response<Tag>> postTagFeature({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/tags/{id}/feature'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Follow a hashtag Documentation](https://docs.joinmastodon.org/methods/tags/#follow)
  Future<Response<Tag>> postTagFollow({
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/tags/{name}/follow'.replaceAll(
      '{'
      r'name'
      '}',
      name.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Unfeature a hashtag Documentation](https://docs.joinmastodon.org/methods/tags/#unfeature)
  Future<Response<Tag>> postTagUnfeature({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/tags/{id}/unfeature'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  /// Official Mastodon API documentation
  /// Also see [Unfollow a hashtag Documentation](https://docs.joinmastodon.org/methods/tags/#unfollow)
  Future<Response<Tag>> postTagUnfollow({
    required String name,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/tags/{name}/unfollow'.replaceAll(
      '{'
      r'name'
      '}',
      name.toString(),
